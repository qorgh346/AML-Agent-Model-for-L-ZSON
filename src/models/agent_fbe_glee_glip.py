...
class AgentFbeGLEEGLIP(AgentFbe):
    '''
    ...
    def __init__(
            ...
            class_remap=None):
        super(AgentFbeGLEEGLIP, self).__init__(fov,
                                               device,
                                               ...
                                               alpha=alpha)
        self.clip_module = ClipOwl("ViT-B/32", classes, classes_clip,
                                   templates, 0.125, device,
