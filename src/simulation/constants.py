...
rooms_captions = '. '.join(THOR_ROOM_TYPES) + '.'
...
THOR_LANDMARK_TYPES = [landmark.lower() for landmark in THOR_LANDMARK_TYPES]
landmark_captions = '. '.join(THOR_LANDMARK_TYPES) + '. wall.'
...
THOR_LONGTAIL_TYPES_MAP = {THOR_LONGTAIL_TYPES[i]: THOR_LONGTAIL_OBJECT_TYPES_CLIP[i] for i in range(len(THOR_LONGTAIL_TYPES))}
